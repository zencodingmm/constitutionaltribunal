...
const History = async () => {
    return (
        <section className='container-fluid bg-[--bg-first] m-auto'>
            <div className='w-full mx-auto flex flex-col lg:flex-row lg:gap-[2.5rem]'>
                <div className='w-full lg:w-[50%]'>
                    <Image src={history} alt='history' className='w-full h-full' />
                </div>
                <div className='w-[80%] lg:w-[50%] mx-auto my-[2rem] xl:m-auto flex flex-col gap-[10px] lg:gap-[16px]'>
