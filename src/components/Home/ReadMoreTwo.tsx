...
const ReadMoreTwo = () => {
    return (
        <Link href={''} className=' flex items-center group px-[12px] lg:px-[10px] xl:px-[12px] py-[10px] lg:py-[8px] xl:py-[10px] w-fit border-[2px] border-solid border-[#8BC34A] rounded-[12px]'>
