        ...
        <div className='w-[90%] mt-[5rem] mx-auto flex flex-col lg:flex-row gap-5 lg:gap-10'>
            ...
            <div className='w-full lg:w-[50%] flex flex-col gap-[16px]'>
                ...
                <div className='w-full flex flex-col gap-[16px] '>
                    <h2 className='lg:text-[22px] md:text-[20px] leading-[30px] font-[500] opacity-70 '>Donation ceremony of the Constitutional</h2>
                    <div className=''>
                        <Image className='object-cover w-full h-full' src={ActivitiesImage} alt='image' />
                    </div>
                    <p className='lg:text-[16px] md:text-[18px] leading-[28px] lg:leading-[26px]  font-[500] opacity-60'>
            ...
            <div className='w-full lg:w-[50%] flex flex-col gap-[16px] mt-8 lg:mt-0'>
                ...
                <div className='w-full flex flex-col gap-[16px] '>
                    <h2 className='lg:text-[22px] md:text-[20px] leading-[30px] font-[500] opacity-70 '>Online Law Library can be accessed </h2>
                    <div className=''>
